...
import { ChatState } from "../../Context/ChatProvider"; // Correct import for ChatState
...
const Login = () => {
  ...
  const submitHandler = async () => {
    ...
    try {
      ...
      setUser(data);  // Assuming setUser is a function from ChatState
      localStorage.setItem("userInfo", JSON.stringify(data));
      setLoading(false);
      navigate("/chats");  // Correct usage of navigate
    } catch (error) {
      toast({
